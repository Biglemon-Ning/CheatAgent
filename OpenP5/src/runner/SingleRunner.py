...
class SingleRunner:
    def parse_runner_args(parser):
        ...
        parser.add_argument("--attack_mode", type=str, help='Test the performance of different attack methods.')
    ...
    def create_optimizer_and_scheduler(self, parameter=None, AEs_epoch=5):
        if self.args.rank == 0 and parameter == None:
            ...
            batch_per_epoch = AEs_epoch
            total_steps = batch_per_epoch // self.args.gradient_accumulation_steps 
            warmup_steps = int(total_steps * self.args.warmup_prop)
            self.args.lr = 50
